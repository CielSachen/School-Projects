...
/**
 * @file graham_scan2.h
 * @brief The header containing the public API of the fast graham scan.
 ...
 */
bool fast_scan(Point points[], const size_t point_count, Point *convex_points[], size_t *convex_point_count);
