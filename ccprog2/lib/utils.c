 ...
 */
void
get_string_input(char *string_input, int length)
{
    int last_index;

    fflush(stdout);

    fgets(string_input, length, stdin);
    ...
    switch (situation_id)
    {
        case MAXED_ENTRIES:
            printf(PRINT_COLOR_YELLOW
                   "You have reached the maximum number of entries." PRINT_COLOR_RESET "\n");

            break;
        case MAXED_TRANSLATIONS:
            printf(PRINT_COLOR_YELLOW
                   "You have reached the maximum number of translations." PRINT_COLOR_RESET "\n");

            break;
        case NO_ENTRIES_WITH_TRANSLATION:
            printf(PRINT_COLOR_YELLOW
                   "There's no entry containing the translation you provided." PRINT_COLOR_RESET
                   "\n");

            printf("\n");

            printf(
                PRINT_BACKGROUND_COLOR_GREEN
        ...
        case NO_ENTRIES_WITH_WORD:
            printf(PRINT_COLOR_YELLOW
                   "There's no entry containing the word you provided." PRINT_COLOR_RESET "\n");
