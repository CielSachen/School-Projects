 ...
 * menu and related utility macros, structs, and functions used throughout the project.
 */
...
/**
 * @brief Adds an entry or multiple entries by asking the user to input their first
 * translations.
