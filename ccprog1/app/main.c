...
#include "tides_of_manila/weather.h"

#define MAXIMUM_PLAYER_TURNS 31

/**
 * @brief The entry point of the Tides of Manila game.
    ...
    while (nPlayerTurns < MAXIMUM_PLAYER_TURNS && !bIsQuitting) {
        ...
        while (!bIsNavigating && !bIsQuitting) {
            ...
            if (cChosenActionId == 'B' || cChosenActionId == 'S') {
                char cChosenCargoId =
                    promptPlayerForCargoId(cChosenActionId, nPlayerBalance, nShipCoconutCargoAmount, nRiceMarketPrice,
                ...
                if (cChosenCargoId != 'X') {
                    ...
                    int nCargoAmount = promptPlayerForCargoAmount(
                        ...
                        nCoconutMarketPrice, nRiceMarketPrice, nSilkMarketPrice, nGunMarketPrice,
                        nShipCoconutCargoAmount, nShipRiceCargoAmount, nShipSilkCargoAmount, nShipGunCargoAmount);
